    ...
    return (
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '6px' }}>
        ...
        >
          ...
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
        </div>
      </div>
    );
  }
